...
function triangle(row) {
	...
	if (maxRow > 2) {
		...
		while (3 <= maxRow  && 2 <= maxRow - 1) {
			...
			else if (secondColour == firstColour && secondColour != thirdColour)
				tmpCol[i] = thirdColour;
			else if (secondColour == thirdColour && secondColour != firstColour)
				tmpCol[i] = firstColour;
				
			else if (firstColour == thirdColour && secondColour != firstColour) {
